                ...
                for line in f.readlines():
                    ...
                    if k_name in string.whitespace:
                        ...
                        if k_name == "arg":
                            ...
                            attack_weight = 1
                            if len(k_args)>2:
                                attack_weight = float(k_args[2])
                            self.add_attack(attacker, attacked, attack_weight)
                            ...
                            support_weight = 1
                            if len(k_args) > 2:
                                support_weight = float(k_args[2])
                            self.add_support(supporter, supported, support_weight)
